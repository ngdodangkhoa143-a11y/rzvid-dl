        ...
        <div className="w-full max-w-6xl mx-auto px-4 md:px-6 py-6 flex flex-col min-h-screen gap-8 md:gap-14">
            ...
            <header className="flex items-center justify-between select-none">
                ...
                <nav className="hidden md:flex items-center gap-8 text-2xs font-bold uppercase tracking-widest text-slate-400">
                    <a href="#" className="text-slate-100 hover:text-white transition-colors">Trang chủ</a>
                    <a href="#features" className="hover:text-slate-200 transition-colors">Tính năng</a>
                    <a href="#platforms" className="hover:text-slate-200 transition-colors">Nền tảng</a>
                    <button 
                        onClick={() => setIsDonateOpen(true)} 
                        className="flex items-center gap-1.5 text-indigo-400 hover:text-indigo-350 transition-all font-bold uppercase tracking-widest"
                    >
                        <span>Donate</span>
                ...
                <div className="flex items-center gap-2.5">
                    <motion.button 
                        ...
                        whileTap={{ scale: 0.97 }}
                        className="text-3xs font-bold uppercase tracking-widest px-3 py-1.5 bg-indigo-650 hover:bg-indigo-600 border border-indigo-500 rounded-xl transition-all block text-white shadow-lg shadow-indigo-500/10"
                    >
                        Donate 💖
                    </motion.button>
                    <motion.div whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.97 }} className="hidden sm:block">
                        <a href="#features" className="text-3xs font-bold uppercase tracking-widest px-3 py-1.5 bg-white/5 border border-white/8 hover:bg-white/10 rounded-xl transition-all block text-slate-355 hover:text-white">
                            SaaS v2.0
                        </a>
                    </motion.div>
                </div>
            ...
            {/* 2. Main content area */}
            <main className="flex flex-col items-center justify-center gap-8 md:gap-12 flex-grow">
                    ...
                    <AnimatePresence mode="wait">
                        ...
                        {status === 'idle' && (
                            ...
                            >
                                ...
                                <div className="max-w-md">
                                    <h3 class="text-xs font-bold uppercase tracking-widest text-slate-200">Sẵn sàng phân tích</h3>
                        ...
                        {status === 'completed' && (
                            ...
                            >
                                ...
                                <div className="max-w-md">
                                    <h3 class="text-sm font-bold uppercase tracking-widest text-slate-100">Tải Xuống Hoàn Tất!</h3>
                        ...
                        {status === 'failed' && (
                            ...
                            >
                                ...
                                <div className="flex flex-col gap-1">
                                    <h3 class="text-xs font-bold uppercase tracking-widest text-slate-200">Không Thể Phân Tích Đường Dẫn</h3>
            ...
            <footer className="border-t border-slate-900 pt-6 pb-2 text-center text-3xs font-semibold uppercase tracking-widest text-slate-500 flex flex-col sm:flex-row items-center justify-between gap-4 select-none">
                <div className="flex gap-4">
                    <a href="#" className="hover:text-slate-350 transition-colors">Tài liệu</a>
                    <span className="text-slate-800">|</span>
                    <a href="#" class="hover:text-slate-350 transition-colors">Tính năng</a>
                    <span class="text-slate-800">|</span>
                    <a href="#" class="hover:text-slate-350 transition-colors">Nền tảng</a>
                </div>
            ...
            {/* 6. Donate Modal with AnimatePresence */}
            <AnimatePresence>
                {isDonateOpen && (
                    <motion.div 
                        initial={{ opacity: 0 }}
                    ...
                    >
                        <motion.div 
                            ...
                            transition={{ type: "spring", duration: 0.5 }}
                            className="glass-panel w-full max-w-sm rounded-2xl p-6 flex flex-col gap-5 relative overflow-hidden cinematic-glow select-none"
                        ...
                        >
                            ...
                            <div className="flex flex-col items-center text-center gap-1.5 mt-2">
                                ...
                                <h3 className="text-sm font-bold text-slate-100 uppercase tracking-wider mt-1.5">Ủng hộ dự án & Tác giả</h3>
                                <p className="text-3xs text-slate-400 uppercase tracking-widest leading-relaxed">Quét mã VietQR để hỗ trợ nhà phát triển</p>
                            </div>

                            {/* QR Code Container */}
                            <div className="bg-white p-2.5 rounded-xl border border-white/10 shadow-lg w-fit mx-auto relative group">
                                <img 
                                    src="donate-qr.jpg" 
                                    alt="Donate QR Code" 
                            ...
                            <div className="bg-white/[0.02] border border-white/5 p-3 rounded-xl flex flex-col gap-1.5 text-center">
                                <span className="text-[10px] text-slate-500 uppercase tracking-widest font-bold">Số tài khoản thụ hưởng</span>
                                <span className="text-xs font-extrabold text-slate-200 uppercase tracking-wider">NGUYEN DO DANG KHOA</span>
                                <span className="text-2xs font-semibold text-slate-350">100883931040 • VietinBank</span>
                                <span className="text-3xs text-slate-500 uppercase tracking-widest font-bold">CN Bac Da Nang - Hoi So</span>
                            </div>

                            {/* Author Info Contacts */}
                            <div className="flex flex-col gap-2 pt-2 border-t border-white/5">
                                <span className="text-[10px] text-slate-500 uppercase tracking-widest font-bold text-center mb-1">Thông tin liên hệ</span>
                                
                                <a href="https://www.facebook.com/ut.1403" target="_blank" rel="noopener noreferrer" className="flex items-center justify-between p-2.5 bg-white/[0.01] hover:bg-white/[0.04] border border-white/5 rounded-xl text-2xs text-slate-300 hover:text-white transition-all group">
                                    ...
                                    <span className="text-slate-500 group-hover:text-slate-350 text-3xs font-semibold">ut.1403</span>
                                </a>

                                <a href="mailto:ngdodangkhoa143@gmail.com" className="flex items-center justify-between p-2.5 bg-white/[0.01] hover:bg-white/[0.04] border border-white/5 rounded-xl text-2xs text-slate-300 hover:text-white transition-all group">
                                    <div className="flex items-center gap-2">
                                    ...
                                    <span className="text-slate-500 group-hover:text-slate-350 text-3xs font-semibold">ngdodangkhoa143@gmail.com</span>
                                </a>

                                <div className="flex items-center justify-between p-2.5 bg-white/[0.01] border border-white/5 rounded-xl text-2xs text-slate-300 select-all group">
                                    <div className="flex items-center gap-2">
                                    ...
                                    <span className="text-slate-500 text-3xs font-semibold">dkhoa_102</span>
                                </div>
                            </div>
                        </motion.div>
                    </motion.div>
